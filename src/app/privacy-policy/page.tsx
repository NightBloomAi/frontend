        ...
        <div className="flex flex-col justify-start gap-y-6">
          ...
          <div className="flex flex-col gap-y-3 text-base">
            ...
            <ul className="list-disc ml-6">
              ...
              <li>
                To provide analysis or valuable information to improve the
                service
              </li>
          ...
          <div className="flex flex-col gap-y-3 text-base">
            <div className="text-[var(--pink)] text-xl">Disclosure of Data</div>
            ...
            <div className="italic">Third-party Service Providers</div>
            <div className="text-base">
              We may employ third-party companies and individuals to facilitate
              our service &#40;&quot;Service Providers&quot;&#41;. They have access to your
              personal data only to perform tasks on our behalf and are
              obligated not to disclose or use it for other purposes.
            </div>
          </div>
          <div className="flex flex-col gap-y-3 text-base">
            <div className="text-[var(--pink)] text-xl">Security of Data</div>
            <div className="text-base">
              We prioritize the security of your data but remember that no
              method of transmission over the Internet or electronic storage is
              100% secure. While we strive to use commercially acceptable means
              to protect your personal data, absolute security cannot be
              guaranteed.
            </div>
          </div>
          <div className="flex flex-col gap-y-3 text-base">
            <div className="text-[var(--pink)] text-xl">Service Providers</div>
            <div className="text-base">
              We may use third-party providers to monitor and analyze the use of
              our service. For example:
            </div>
            <ul className="list-disc ml-6">
              <li>Payment processors for any subscription services</li>
              <li>Analytics providers to analyze website usage</li>
            </ul>
          </div>
          <div className="flex flex-col gap-y-3 text-base">
            <div className="text-[var(--pink)] text-xl">
            ...
            <div className="text-base">
              ...
              third-party link, you will be directed to their site. We advise
          ...
          <div className="flex flex-col gap-y-3 text-base">
            ...
            <div className="text-base">
              ...
              children under 18. If you are a parent/guardian and believe your
              child provided us with personal data, please contact us.
            </div>
          </div>
          <div className="flex flex-col gap-y-3 text-base">
            <div className="text-[var(--pink)] text-xl">
          ...
          <div className="flex flex-col gap-y-3 text-base">
            <div className="text-[var(--pink)] text-xl">Contact Us</div>
            <div className="text-base">
              If you have any questions about this Privacy Policy, please
              contact us at nightbloom.ai
            </div>
          </div>
        </div>
      </section>
