            ...
            <div className="flex flex-col justify-start gap-y-6">
                <div className="flex flex-col gap-y-3">
                    ...
                    <div className="text-base">
                        Welcome to NightBloom. We recognize the importance of
                        your privacy and are committed to protecting any
                        personal data we collect about you. This Privacy Policy
                        explains how we collect, use, disclose, and safeguard
                        your information when you visit our web application.
                    </div>
                </div>
                <div className="flex flex-col gap-y-3 text-base">
                    ...
                    <div className="text-base">
                        When you register for an account or use our services, we
                        may ask for your:
                    </div>
                ...
                <div className="flex flex-col gap-y-3 text-base">
                    ...
                    <div className="text-base">
                        ...
                        facilitate our service &#40;&quot;Service
                        Providers&quot;&#41;. They have access to your personal
                ...
                <div className="flex flex-col gap-y-3 text-base">
                    ...
                    <div className="text-base">
                        We may use third-party providers to monitor and analyze
                ...
                <div className="flex flex-col gap-y-3 text-base">
                    ...
                    <div className="text-base">
                        ...
                        their site. We advise reviewing the Privacy Policy of
                ...
                <div className="flex flex-col gap-y-3 text-base">
                    ...
                    <div className="text-base">
                        Our service is not intended for individuals under 18. We
                        do not knowingly collect personally identifiable
                        information from children under 18. If you are a
                        parent/guardian and believe your child provided us with
                ...
                <div className="flex flex-col gap-y-3 text-base">
                    ...
                    <div className="text-base">
                        We may update our Privacy Policy periodically. You are
