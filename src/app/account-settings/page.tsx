                  ...
                  <div className="bg-[var(--trans-light-grey)] rounded-b md:w-5/6 w-11/12 -mt-6 duration-300 px-4 py-6 flex items-center justify-center">
                    ...
                    {(item.name == "Password") && (
                        <form className="flex flex-col gap-y-6">
                            ...
                            <input placeholder="Old Password" className="bg-transparent border-solid border-2 border-[var(--lightest-grey)] rounded placeholder:text-[var(--lightest-grey)] px-4 py-2 w-96 -mt-3"></input>
                            <div>Enter New Password</div>
                            <input placeholder="New Password" className="bg-transparent border-solid border-2 border-[var(--lightest-grey)] rounded placeholder:text-[var(--lightest-grey)] px-4 py-2 w-96 -mt-3"></input>
                            <button type="submit" className="px-6 py-2 border-solid border-[var(--lightest-grey)] border-2 rounded-full hover:bg-[var(--lightest-grey)] hover:text-[var(--opaque-trans-grey)] duration-300 cursor-pointer w-24 ml-auto">Save</button>
