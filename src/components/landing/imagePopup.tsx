        ...
        >
          <div className="flex sm:flex-row flex-col relative lg:gap-x-12 sm:gap-x-9 w-full items-center justify-center sm:items-start sm:gap-y-0 gap-y-9">
            ...
            <div className="flex-1 sm:w-7/12 w-11/12 sm:mb-0 mb-5">
              ...
              <div className="flex flex-row w-full justify-start gap-x-6 items-start ">
                <a
                  href={gridImageURL({
                    reference_job_id: imageInfo.reference_job_id,
                  })}
                ...
                <div className="flex flex-col w-auto gap-y-2">
                  {imageInfo?.category !== "none" && (
                    <div className="flex flex-row h-8 w-full border-2 border-[var(--light-grey)] rounded-md justify-start items-center p-2 pr-3 text-sm gap-x-1">
                      <StyleIcon className="h-4" />
                      <div>{imageInfo?.category.replace(/_/g, " ")}</div>
                    </div>
                  )}
                  <div className="flex flex-row h-8 w-full border-2 border-[var(--light-grey)] rounded-md justify-start items-center p-2 pr-3 text-sm gap-x-1">
                    <CalendarTodayIcon className="h-4" />
                    <div>{imageInfo.generation_time.slice(0, 10)}</div>
                  </div>
                  <div className="flex flex-row h-8 w-full border-2 border-[var(--light-grey)] rounded-md justify-start items-center p-2 pr-3 text-sm gap-x-1">
                    <OpenWithIcon className="h-4" />
                    <div>{`${imageInfo.height} x ${imageInfo.width}`}</div>
                  </div>
                </div>
              </div>
            </div>
